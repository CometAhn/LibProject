...
<link href="http://localhost/css/signin.css" rel="stylesheet">
		...
		<div class="w-25 p-3 border border-dark border-opacity-25 rounded d-flex justify-content-center">
			...
			<form name="newMember" class="form-signin" action="/Lib/findidd" method="post" onsubmit="return checkForm()">
				...
				<div class="form-floating">
					<input type="email" class="form-control" name="email" value="${email}" placeholder="test@mail.com" required> <label for="floatingInput">이메일</label>
				</div>
				<div class="p-3 d-flex justify-content-center">
					<div class="g-recaptcha" data-sitekey="6LctdVYiAAAAANSXZSeaohuJzWh5SCH6mvjrd-o9"></div>
				</div>
				<p>
					<button class="btn btn btn-lg btn-primary btn-block" type="submit">아이디 조회</button>
				</p>
